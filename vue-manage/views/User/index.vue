<!-- 第二个common form有什么作用？
新增按钮为什么要放在第二个div里面？
搜索按钮为什么要放在common form中间？ -->
<template>
    <div class="manage">
        <el-dialog :title="operateType === 'add' ? '新增' : '更新'" :visible.sync="isShow">
            <common-form :form-label="operateFormLabel" :form="operateForm" :inline="true" ref="form">
            </common-form>
        ...
        <div class="manage-header">
            ...
            <common-form :form-label="formLabel" :form="searchForm" :inline="true" ref="form">
